...
(function() {
  ...
  BaseEngine = (function() {
    ...
    BaseEngine.prototype._maybe_call_callback = function() {
      ...
      if ((this._exit_cb != null) && this._can_finish()) {
        cb = this._exit_cb;
        this._exit_cb = null;
        return cb(this._err, this._exit_code, this._exit_signal);
      }
    };
  ...
  exports.SpawnEngine = SpawnEngine = (function(_super) {
    ...
    SpawnEngine.prototype._run = function(cb) {
      ...
      (function(_this) {
        ...
        return function() {
          ...
          _this.proc.on('exit', function(status, signal) {
            return _this._got_exit(status, signal);
          });
    ...
    SpawnEngine.prototype._got_exit = function(status, signal) {
      this._exit_code = status;
      this._exit_signal = signal;
      this.proc = null;
      this.pid = -1;
      return this._maybe_call_callback();
    };
    ...
    SpawnEngine.prototype._can_finish = function() {
      return ((this._err != null) || (this._exit_code != null) || (this._exit_signal != null)) && this._closed;
    };
  ...
  exports.ExecEngine = ExecEngine = (function(_super) {
    ...
    ExecEngine.prototype.run = function(cb) {
      var argv;
      ...
      (function(_this) {
        ...
        return function() {
          ...
          if (_this._err == null) {
            ...
            if (_this._err.signal != null) {

            } else if (_this._err.code === 127) {
  ...
  exports.run = run = function(inargs, cb) {
    var args, b, def_out, eklass, eng, engklass, err, log, name, opts, other_fds, out, quiet, rc, run_cb, signal, stderr, stdin, stdout, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    args = inargs.args, stdin = inargs.stdin, stdout = inargs.stdout, stderr = inargs.stderr, quiet = inargs.quiet, name = inargs.name, eklass = inargs.eklass, opts = inargs.opts, engklass = inargs.engklass, log = inargs.log, other_fds = inargs.other_fds, run_cb = inargs.run_cb;
    ...
    (function(_this) {
      ...
      return function() {
        if ((err == null) && (typeof rc !== "undefined" && rc !== null) && (rc !== 0)) {
          eklass || (eklass = Error);
          err = new eklass("exit code " + rc);
          err.rc = rc;
        } else if ((err == null) && (typeof signal !== "undefined" && signal !== null)) {
          eklass || (eklass = Error);
