...
(function() {
  var BaseEngine, ExecEngine, SpawnEngine, bufferify, exec, iced, run, set_log, spawn, stream, util, __iced_k, __iced_k_noop, _engine, _log, _quiet, _ref,
  ...
  exports.SpawnEngine = SpawnEngine = (function(_super) {
    ...
    SpawnEngine.prototype._got_close = function(code) {
      this._err = new Error("failed to launch process; guessing ENOENT");
      return this._err.errno = 'ENOENT';
    };
    ...
    SpawnEngine.prototype._got_eof = function() {
      --this._n_out;
      return this._maybe_call_callback();
    };
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/max/src/iced-spawn/src/cmd.iced",
